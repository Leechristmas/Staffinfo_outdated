...
ALTER TABLE OPERATIONS_LOG
	ADD
		CONSTRAINT FK_OPERATIONS_LOG_SESSION_LOG
				   FOREIGN KEY (SESSION_ID) REFERENCES SESSION_LOG ON DELETE CASCADE;
GO
...
CREATE PROCEDURE CHECK_USER 
	...
	@PASSWORD VARCHAR(20)
AS
	IF (SELECT COUNT(*) FROM USERS WHERE USER_LOGIN = @LOGIN AND USER_PASSWORD = @PASSWORD) = 1
	BEGIN
		INSERT INTO SESSION_LOG SELECT ID, GETDATE() FROM USERS WHERE USER_LOGIN = @LOGIN AND USER_PASSWORD = @PASSWORD;
...
AS
	...
	BEGIN 
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'CLASINESS', GETDATE(), 'ОБНОВЛЕНА КЛАССНОСТЬ ЗА ' + CAST(CLASINESS_DATE AS VARCHAR(20)) FROM DELETED
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'CLASINESS', GETDATE(), 'ДОБАВЛЕНА КЛАССНОСТЬ ЗА ' + CAST(CLASINESS_DATE AS VARCHAR(20)) FROM INSERTED
	END
GO
...
AS
	...
	BEGIN 
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'CLASINESS', GETDATE(), 'УДАЛЕНА КЛАССНОСТЬ ЗА ' + CAST(CLASINESS_DATE AS VARCHAR(20)) FROM DELETED;
	END
GO
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'CONTRACTS', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'CONTRACTS', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'CONTRACTS', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'EDUCATIONAL_INSTITUTION', GETDATE(), 
				   'ОБНОВЛЕНО УЧЕБНОЕ ЗАВЕДЕНИЕ "' + (SELECT INST_TITLE FROM EDUCATIONAL_INSTITUTION E WHERE E.ID = DELETED.ID) + '"'
			FROM DELETED
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'EDUCATIONAL_INSTITUTION', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'EDUCATIONAL_INSTITUTION', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'EDUCATION_TIME', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'EDUCATION_TIME', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'EDUCATION_TIME', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'GRATITUDE', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'GRATITUDE', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'GRATITUDE', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'HOLIDAY_TIME', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'HOLIDAY_TIME', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'HOLIDAY_TIME', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'HOSPITAL_TIME', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'HOSPITAL_TIME', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'MILITARY_PROCESS', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'MILITARY_PROCESS', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'MILITARY_PROCESS', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'POST_ASSIGNMENT', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'POST_ASSIGNMENT', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'POST_ASSIGNMENT', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'RANK_ASSIGNMENT', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'RANK_ASSIGNMENT', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'RANK_ASSIGNMENT', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'RELATIVE', GETDATE(), 
				   'ОБНОВЛЕНА ЗАПИСЬ О РОДСТВЕННИКЕ "'+ LAST_NAME + '"'
			FROM DELETED
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'RELATIVE', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'RELATIVE', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'REPRIMAND', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'REPRIMAND', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'REPRIMAND', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'SERTIFICATION', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'SERTIFICATION', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'SERTIFICATION', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'SPECIALITY', GETDATE(), 
				   'ОБНОВЛЕНА СПЕЦИАЛЬНОСТЬ "' + (SELECT SPECIALITY FROM SPECIALITY E WHERE E.ID = DELETED.ID) + '"'
			FROM DELETED
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'SPECIALITY', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'SPECIALITY', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'EMPLOYEE', GETDATE(), 
...
AS
	...
	BEGIN
		...
		IF (SELECT COUNT(*) FROM DELETED) > 0
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'UPDATE', 'VIOLATION', GETDATE(), 
		...
		ELSE 
			INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'INSERT', 'VIOLATION', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'VIOLATION', GETDATE(), 
...
AS
	...
	BEGIN
		DECLARE @SESSIONID INT = (SELECT MAX(ID) FROM SESSION_LOG);	--ID ТЕКУЩЕЙ СЕССИИ
		INSERT INTO OPERATIONS_LOG(SESSION_ID, OPERATION_TYPE, TABLENAME, OPERATION_TIME, DESCRIPTION)  
			SELECT @SESSIONID, 'DELETE', 'MILITARY_UNIT', GETDATE(), 
